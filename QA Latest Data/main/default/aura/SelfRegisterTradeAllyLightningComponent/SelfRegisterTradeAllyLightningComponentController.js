({
    ...
    handleSelfRegister: function(component, event, helper) {
        ...
        if (wasGoogleRecaptchaPassed || !wasRecaptchaIncluded) {
            var selfRegisterTradeAllyWrapper = {
                ...
                'companyCity': component.get('v.companyBillingCity'),
                'companyState': component.get('v.companyBillingState'),
                'companyType': component.get('v.companyBusinessType'),
                'companyPhoneNumber': component.get('v.companyPhoneNumber'),
    ...
    handleTradeAllyDuplicateSelect: function(component, event, helper) {
        helper.handleTradeAllyDuplicateSelect(component, event);
    },

    handleDeclineAllTradeAllyDuplicates: function(component, event, helper) {
        helper.handleDeclineAllTradeAllyDuplicates(component, event);
    }
